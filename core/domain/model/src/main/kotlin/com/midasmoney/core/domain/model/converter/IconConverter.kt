...
object IconConverter {
    fun getImageVector(iconModel: IconModel): ImageVector {
        return when (iconModel.iconType) {
            ...
            IconType.ACCOUNT_BALANCE -> Icons.Filled.AccountBalance
            IconType.CREDIT_CARD -> Icons.Filled.CreditCard
        }
    }
    ...
    fun getIconType(icon: ImageVector): IconType? {
        return when (icon) {
            ...
            Icons.Filled.AccountBalance -> IconType.ACCOUNT_BALANCE
            Icons.Filled.Savings -> IconType.SAVINGS
            Icons.Filled.CreditCard -> IconType.CREDIT_CARD
            else -> null
        }
    }
}
